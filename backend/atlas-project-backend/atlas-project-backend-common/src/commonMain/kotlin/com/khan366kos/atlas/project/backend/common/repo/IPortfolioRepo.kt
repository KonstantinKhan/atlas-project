...
interface IPortfolioRepo {
    ...
    suspend fun createProject(portfolioId: String, name: String, priority: ProjectPriority): Project
    suspend fun updateProject(projectId: String, name: String?, priority: ProjectPriority?): Int
